...
T.Dial {
  ...
  background: Rectangle {
    ...
    height: width
    color: control.pressed ? Qt.alpha(control.palette.active.accent, 0.1) :"transparent"
    radius: width / 2

    border.color: control.enabled ? control.palette.active.accent : control.palette.disabled.text
